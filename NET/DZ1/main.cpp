    ...
    while (true)
    {
        ...
        if (recv_len > 0)
        {
            ...
            std::cout
                ...
                << "("<<getnameinfo(reinterpret_cast<sockaddr*>(&client_address), client_address_len, client_address_buf, sizeof(client_address_buf), nullptr, 0, NI_NAMEREQD)<< ")"
